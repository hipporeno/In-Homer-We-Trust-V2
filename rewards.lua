...
-- Level 1
-- TOTAL Cost: $750
BindReward( "famil_v", "art\cars\famil_v.p3d", "car", "forsale", 1, 500, "gil" )
...
BindReward( "mitsu", "art\cars\mitsu.p3d", "car", "defaultcar", 1)
...
BindReward( "mrplo_v", "art\cars\mrplo_v.p3d", "car", "forsale", 2, 200, "simpson" ) Homer
BindReward( "cLimo", "art\cars\cLimo.p3d", "car", "forsale", 2, 150, "gil" )
BindReward( "cFire_v", "art\cars\cFire_v.p3d", "car", "forsale", 2, 250, "gil" )

BindReward( "bart", "art\chars\bart_m.p3d", "skin", "defaultskin", 2 )
BindReward( "b_tall", "art\chars\b_tall_m.p3d", "skin", "forsale", 2, 150, "interior" )
BindReward( "b_football", "art\chars\b_foot_m.p3d", "skin", "forsale", 2, 200, "interior" )
BindReward( "b_ninja", "art\chars\b_ninj_m.p3d", "skin", "forsale", 2, 250, "interior" )
...
BindReward( "otto_v", "art\cars\otto_v.p3d", "car", "forsale", 3, 300, "simpson" )  Otto
BindReward( "cDonut", "art\cars\cDonut.p3d", "car", "forsale", 3, 250, "gil" )
BindReward( "cNerd", "art\cars\cNerd.p3d", "car", "forsale", 3, 250, "gil" )

BindReward( "lisa", "art\chars\lisa_m.p3d", "skin", "defaultskin", 3 )
BindReward( "l_cool", "art\chars\l_cool_m.p3d", "skin", "forsale", 3, 250, "interior")
BindReward( "l_florida", "art\chars\l_flor_m.p3d", "skin", "forsale", 3, 250, "interior")
BindReward( "l_jersey", "art\chars\l_jers_m.p3d", "skin", "forsale", 3, 300, "interior")
...
BindReward( "willi_v", "art\cars\willi_v.p3d", "car", "forsale", 4, 400, "simpson" )  Willie
BindReward( "cKlimo", "art\cars\cKlimo.p3d", "car", "forsale", 4, 350, "gil" )
BindReward( "cCurator", "art\cars\cCurator.p3d", "car", "forsale", 4, 300, "gil" )

BindReward( "marge", "art\chars\marge_m.p3d", "skin", "defaultskin", 4 )
BindReward( "m_prison", "art\chars\m_pris_m.p3d", "skin", "forsale", 4, 300, "interior" )
BindReward( "m_pink", "art\chars\m_pink_m.p3d", "skin", "forsale", 4, 350, "interior" )
BindReward( "m_police", "art\chars\m_poli_m.p3d", "skin", "forsale", 4, 400, "interior" )
...
BindReward( "carhom_v", "art\cars\carhom_v.p3d", "car", "forsale", 5, 500, "simpson" )  Homer
BindReward( "wiggu_v", "art\cars\wiggu_v.p3d", "car", "forsale", 5, 425, "gil" )
BindReward( "cCola", "art\cars\cCola.p3d", "car", "forsale", 5, 350, "gil" )

BindReward( "apu", "art\chars\apu_m.p3d", "skin", "defaultskin", 5 )
BindReward( "a_army", "art\chars\a_army_m.p3d", "skin", "forsale", 5, 375, "interior" )
BindReward( "a_american", "art\chars\a_amer_m.p3d", "skin", "forsale", 5, 425, "interior" )
BindReward( "a_besharp", "art\chars\a_besh_m.p3d", "skin", "forsale", 5, 475, "interior" )
...
BindReward( "burns_v", "art\cars\burns_v.p3d", "car", "streetrace", 6 )
BindReward( "scorp_v", "art\cars\scorp_v.p3d", "car", "forsale", 6, 600, "simpson" )  Kearney
BindReward( "cArmor", "art\cars\cArmor.p3d", "car", "forsale", 6, 400, "gil" )
BindReward( "cSedan", "art\cars\cSedan.p3d", "car", "forsale", 6, 500, "gil" )

BindReward( "bart", "art\chars\bart_m.p3d", "skin", "defaultskin", 6 )
BindReward( "b_hugo", "art\chars\b_hugo_m.p3d", "skin", "forsale", 6, 400, "interior" )
BindReward( "b_military", "art\chars\b_mili_m.p3d", "skin", "forsale", 6, 500, "interior" )
BindReward( "b_man", "art\chars\b_man_m.p3d", "skin", "forsale", 6, 600, "interior" )
...
BindReward( "zombi_v", "art\cars\zombi_v.p3d", "car", "forsale", 7, 500, "simpson" )  Zombie
BindReward( "hbike_v", "art\cars\hbike_v.p3d", "car", "forsale", 7, 1000, "gil" )
BindReward( "cHears", "art\cars\cHears.p3d", "car", "forsale", 7, 750, "gil" )
...
SetCarAttributes( "mitsu", 4, 4.5, 4.5, 4 )

 Level 2
SetCarAttributes( "honor_v", 1.5, 2, 1.5, 5 )
SetCarAttributes( "gramp_v", 1.5, 1.5, 3.5, 3 )
